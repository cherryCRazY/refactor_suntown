        ...
        <section className='form_section'>
          <div className='container form_container'>
            <div className='form_box'>
              <h2>{lang ? 'Свяжитесь с нами':'Зв\'яжіться з Нами'}</h2>
              ...
              {
                lang ? <p className='form_description'>Если у Вас есть вопросы или предложение, мы всегда рады Вам помочь</p>
              ...
              <div className='form_inputs_container'>
                <div className='form_inputs_column form_column_3'>
                  <div className='form_input_box'>
                    <label htmlFor='mail'>{lang ? 'Электронный адрес*' : 'Електронна адреса*'}</label>
                    <input 
                      type='email' 
                      id='mail' 
                      name='email' 
                  ...
                  <div className='form_input_box'>
                    <label htmlFor='firstname'>{lang ? 'Имя*' : 'Ім\'я*'}</label>
                    <input 
                      type='text' 
                      id='firstname' 
                      name='firstName' 
                  ...
                  <div className='form_input_box'>
                    <label htmlor='lastname'>{lang ? 'Фамилия*' : 'Прізвище*'}</label>
                    <input 
                      type='text' 
                      id='lastname' 
                      name='secondName' 
                  ...
                  <div className='form_input_box'>
                    <label htmlFor='company_name'>{lang ? 'Название Вашей компании*' : 'Назва вашої компанії*'}</label>
                    <input 
                      type='text' 
                      id='company_name' 
                      name='companyName' 
                  ...
                  <div className='form_input_box'>
                    <label htmlFor='telephone'>{lang ? 'Контактный номер' : 'Контактний номер'}</label>
                    <input 
                      type='tel' 
                      id='telephone' 
                      name='phone' 
                ...
                <div className='form_inputs_column form_column_3'>
                  <div className='form_input_box'>
                    <label htmlFor='position'>{lang ? 'Должность' : 'Посада'}</label>
                    <input 
                      id='position'
                      name='position' 
                  ...
                  <div className='form_input_box selector_box'>
                    <label>{lang ? 'Выберите Ваш город' : 'Оберіть ваше місто'}</label>
                ...
                <div className='form_inputs_column form_column_4'>
                  <div className='form_input_box selector_box'>
                    <label>{lang ? 'По какому поводу обращаетесь' : 'З приводу чого звертаєтесь'}</label>
                  ...
                  <div className='form_input_box'>
                    <label htmlFor='message'>{lang ? 'Введите Ваше сообщение' : 'Введіть ваше повідомлення...'}</label>
                    <textarea 
                      id='message'
                      name='message' 
                  ...
                  <div className='form_agreement_box'>
                    ...
                    <label>{lang ? 'Вы согласны с использованием Ваших персональных данных в соответствии с условиями документа?' : 'Ви погоджуєтесь з використанням ваших персональних данних згідно з умовами'} <a href='#'>документу</a> ?</label>
                  </div>
                  <div className='form_agreement_box'>
                    <div className='form_check_box form_check_box_distribution'>
                      <div className='form_check_flag'></div>
                    </div>
                    <label>{lang ? 'Хочу быть в курсе последних событий' : 'Хочу бути в курсі останніх новин.'}</label>
                  </div>
                </div>
              </div>
            </div>
            <div className='form_submit_button' onClick={this.handleSubmit}>
              <div className='form_submit_error'>
                <p id='form_error_msg'>{lang ? 'Вы ввели некорректные данные' : 'Ви ввели некоректні данні'}</p>
              </div>
              <span>{lang ? 'Отправить' : 'Відправити'}</span>
            </div>
          </div>
        </section>
      </div>
