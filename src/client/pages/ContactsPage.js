    ...
    return (
      <div>
            <SEO
                    ...
                    url={"https://suntown-ukraine.com/contacts"}
                ></SEO>
        ...
        <div className='contacts'>
          ...
          <section className='contacts_section'>
            <div className='container contacts_advantages_box'>
              ...
              <Link to={this.props.location.pathname.includes("/ua") ? '/ua/form' : '/form'}>
...
export function loadDataContacts({ dispatch }, path) {
    const lang = path.includes("/ua") ? "ua" : "ru";

    const promises = [dispatch(getSeoByUrl("contacts", lang))];
