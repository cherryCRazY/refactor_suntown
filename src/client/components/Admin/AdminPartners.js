...
const initialState = {
  post: {
    ...
    admin_partners_description: RichTextEditor.createEmptyValue(),
    admin_partners_url: '',
  ...
  selectPartner = e => {
    ...
    if(partner.hasRu){
      postRu = {
        ...
        admin_partners_description: RichTextEditor.createValueFromString(partner.descriptionRu, 'html'),
    ...
    this.setState({
      ...
      post: {
        ...
        admin_partners_description: RichTextEditor.createValueFromString(partner.description, 'html'),
      ...
      postRu : {
        ...postRu,
        admin_partners_description: partner.hasRu ? RichTextEditor.createValueFromString(partner.descriptionRu, 'html') : RichTextEditor.createEmptyValue()
      },
      isRu: false,
      edditing: true,
